...
export const ALL_MINI_GAMES: MiniGame[] = [
  ...
  },
  {
    ...
    phaseId: 'fase-b',
    name: 'Egrang Bilangan Cacah',
    description: 'Melangkah seimbang di atas egrang bambu dengan menebak nilai tempat ribuan, ratusan, puluhan, dan urutan bilangan s.d. 10.000!',
    category: 'Bilangan Cacah & Nilai Tempat',
    thumbnailIcon: '🎋',
    isLocked: false,
    bgGradient: 'from-teal-400 to-emerald-600',
    accentColor: '#0d9488',
    tag: 'Nilai Tempat & Bilangan s.d. 10.000',
    rewardCoins: 50,
    difficulty: 'Sedang',
  },
  {
